...
class RegisterFormWidget extends StatelessWidget {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _buildFlatButton(context, 'Login'),
  ...
  _onPressButton(BuildContext context, LoginBloc bloc) async {
    ...
    UserToken userToken = await bloc
        .registerUser(User(email: bloc.email, password: bloc.password));
    if (userToken.isOk) {
      Navigator.pushNamed(context, HomePage.routeName);
    } else {
      showAlertMessage(context, userToken.message);
    }
  }
}
